---
id: source-data-equality-manifesto
title: 数据平权宣言全文
visibility: public
status: approved
kind: source
source_path: ideal/第一个产品/宣言-数据平权.md
sources:
  - ideal/第一个产品/宣言-数据平权.md
tags:
  - 数据平权
  - 宣言
  - 全文
...
v0.4，端午摆摊公开版。治理与自我约束条款见《牛马互助协议》。
...
平台不仅锻造了置自身于死地的武器，也就是白菜价的软件生产力；它还产生了将要运用这种武器的人，也就是被它收租二十年的工友。

工友不按行业划分，而按人在生产关系中的位置划分。工友指不占有平台、数据与算法，因而不得不向数字领主交租、出卖劳动来维持生活的一切人：一产二产劳动者、服务业新蓝领、个体经营者、失业待业者、无偿再生产劳动者、被去技能化的低级白领。
...
有人已经站到了消费端：拼多多、直播、团购、UGC。有意或无意，它们是被资本收益率逼着走到这一步的，但这不是觉悟。

其一，它们不彻底。站在消费端，却踩着另一端的小生产者，把一部分人民喂给另一部分人民。

其二，让利只是饵。大部分收益最终仍进了资本家的口袋。它们不把阳谋说出口，闷声赚到钱，再装进自己口袋。
